...
\inputencoding{utf8} Frederick Solt, Yue Hu, et al. ``Economic
...
\inputencoding{utf8} Wen Fang Tang, Yue Hu, et al. ``Affirmative
Inaction: Language Education and Labor Mobility among China's Muslim
Minorities''. \emph{Chinese Sociological Review} 4.48 (2016),
pp.~346-66.

\inputencoding{utf8} Yue Hu. ``Institutional Difference and Cultural
Difference: A Comparative Study of Canadian and Chinese Cultural
Diplomacy''. \emph{Journal of American-East Asian Relations} 20.2-3
(2013), pp.~256-68.
\url{http://booksandjournals.brillonline.com/content/journals/10.1163/18765610-02003011}.

\inputencoding{utf8} Yue Hu and Yuchao Zhu. ```Issue-Oriented' vs.
`Ism-Oriented': Indigenizing Political Science in China?''
{[}Chinese{]}. \emph{Tianjin Social Science} 3 (2011), pp.~46-50.

\inputencoding{utf8} Tongshun Cheng and Yue Hu. ``The Cultural Props of
Foreign Policy''. {[}Chinese{]}. \emph{Tribune of Study} (2010),
pp.~33--37.

\inputencoding{utf8} Yue Hu. ``An Analysis of Politics Fixed Position of
CPPCC from the Political Scientific Angle''. {[}Chinese{]}.
\emph{Journal of Tianjin Institute of Socialism} 1 (2009), pp.~19-23.

\subsection{Software}\label{software}

\inputencoding{utf8} Frederick Solt and Yue Hu. ``pewdata: Reproducible
Retrieval of Pew Research Center Datasets''.
\emph{The Comprehensive R Archive Network (CRAN)} (2016).
\url{http://CRAN.R-project.org/package=pewdata}.

\inputencoding{utf8} Frederick Solt and Yue Hu. ``dotwhisker:
Dot-and-Whisker Plots of Regression Results''.
\emph{The Comprehensive R Archive Network (CRAN)} (2015).
\url{http://CRAN.R-project.org/package=dotwhisker}.

\inputencoding{utf8} Frederick Solt and Yue Hu. ``interplot: Plot the
Effects of Variables in Interaction Terms''.
\emph{The Comprehensive R Archive Network (CRAN)} (2015).
...
\inputencoding{utf8} Yue Hu. ``Experiences on Document Preparation for
Applications to PhD Programs of American Universities''. {[}Chinese{]}.
\emph{New Vision} 17 (2014), pp.~37-38.

\inputencoding{utf8} Yue Hu. ``Nothing Honored, So\ldots{}''
{[}Chinese{]}. \emph{New Vision} (2010), pp.~25-26.

\inputencoding{utf8} Yue Hu. ``Three Harmonies of Premier Zhou Enlai''.
{[}Chinese{]}. \emph{National Spirit} 17 (2007), p.~45.

\inputencoding{utf8} Yue Hu. ``Philo-mathematics: A Methodology of
Politicians.'' {[}Chinese{]}. \emph{Beauty of Mathematics} 1 (2006),
pp.~157-160.

\inputencoding{utf8} Yue Hu. ``The Greatness of Open Sources''.
{[}Chinese{]}. \emph{LUPA-STAR Essay Compilation} (2006), pp.~24-25.
