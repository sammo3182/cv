...
Yue Hu and Yuchao Zhu.
```问题与主义'导向之争:西方比较政治学沿革及其借鉴意义 (`Issue-Oriented'
vs. `Ism-Oriented': Indigenizing Political Science in China?)''.
{[}Chinese{]} \emph{Tianjin Social Science} 3 (2011), pp.~46-50.

Tongshun Cheng and Yue Hu. ``对外政策的文化道具：浅析文明冲突论的工具性
(The Cultural Props of Foreign Policy)''. {[}Chinese{]}
\emph{Tribune of Study} (2010), pp.~33--37.

Yue Hu. ``从政治科学角度分析人民政协的政治定位 (An Analysis of Politics
Fixed Position of CPPCC from the Political Scientific Angle)''.
{[}Chinese{]} \emph{Journal of Tianjin Institute of Socialism} 1 (2009),
pp.~19-23.
