...
\subsubsection{Article in English (Peer-Reviewed
Journals)}\label{article-in-english-peer-reviewed-journals}
...
\subsubsection{Articles in Chinese}\label{articles-in-chinese}
...
Public Attitudes: Evidence from the Chinese-Speaking World''. (2017).
