...
* Ph.D. in Political Science, The University of Iowa, U.S.A.\hfill 2018-05 (Expected)
    + \footnotesize Dissertation: "Rebuild the Tower of Babel: Language Policy and Political Trust in China."
        ...
        + Abstract: My dissertation uncovers a new path by which authoritarian governments impact public opinion---language policy. Conventionally, the policy is regarded as a social institution to set the official language and the linguistic hierarchy of a country. My research argues and demonstrates with various empirical evidence that an authoritarian government can use it as a political tool to influence citizens' political trust and thoughts profoundly. Especially, it empowers the official language that bureaucrats, the grassroots representatives of the government, can use to reinforce their political identities and enhance the citizens' trust in them. To test this theory, I conducted an original field experiment on Chinese high school students and found that using the official language significantly improve listeners' trust in the bureaucrats and this attitude closely relates to the bureaucrats' political identity rather than cultural or personal characteristics. My dissertation also uncovers that official language proficiency can adjust Chinese citizens' trust in political institutions with a modifier analysis of a recent nationally representative sample and shows how the government strategically manipulates the formal political language system to communicate with citizens and influence their political value system based on a computer-assisted text analysis of 1,371,607 political articles. The research concludes that an authoritarian government can use language policy to affect various levels of public political trust through speaking, listening, and reading and manifests that political trust in political actors, political institutions, and political values connected and influenced each other.
...
# Research Interests
* *Comparative Politics*: Language policy, political communication, public opinion.
