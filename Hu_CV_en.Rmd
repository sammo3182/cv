...
* Ph.D. in Political Science, The University of Iowa, U.S.A.\hfill 2018-05 (Expected)
    ...
    + \footnotesize Dissertation: "Dominant Language: A Political Stabilizer."
        ...
        + Abstract: My dissertation provides a new perspective---language policy---to understand political trust in authoritarian countries. The research theorizes that a single-official-language policy can improve its citizens' trust in the central and local governments, the bureaucrats that represent the authority, and the political value system that favors the authoritarian regime through language policy. In particular, the policy favors the official language speakers in the social life and political communications. They can earn more positive self-evaluations in the society and fewer misunderstandings and inefficiency in political communications and thus have more trust in the policy makers and executors. I tested this argument with a nationally representative survey and found that, although not significantly altering the trust in the central government, promoting citizens' official language proficiency does increase the positive influence of self-social evaluation and reduce the negative influence of political activism on the trust in the local government. Additionally, the single-official-language policy provides the official language a special political property as the "authority accent."Bureaucrats can use it to reinforce their political identity. The citizens, in turn, are expected to project more of their attitudes towards the government to these identity-reinforced bureaucrats. With a modified matched-guise method and an original field experiment with Chinese high school students, I found empirical evidence supporting this argument and demonstrated the importance of identity-based language attitude for political trust research. Finally, using a computer-assisted text analysis on 1,371,607 political articles, I uncovered a refocusing strategy of the Chinese government to manipulate the political language system based on the official language that can masquerade political concepts, such as democracy, as consistent with commonly accepted liberal values in the international society but work for the preservation of the legitimacy of the authoritarian regime. My dissertation concludes that an authoritarian government can use language policy to affect various levels of public political trust through all of the speaking, listening, and reading aspects.
